        ...
        $results = DB::select( DB::raw(
            ...
            (
                ...
                (
                    ...
                    (
                        select fencer_id, count(fencer_id) as by_one_wins from
                        (
                    ...
                    (
                        select fencer_id as loss_fencer_id, count(fencer_id) as by_one_losses from
                        (
                        ...
                        group by loss_fencer_id
                    ) as by_one_loss_select_total
